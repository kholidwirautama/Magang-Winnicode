...
class News(models.Model):
    ...
    ocatid = models.IntegerField(default=0, db_index=True)  # ocatid means original cat id.for count news
    ...
    rand = models.BigIntegerField(default=0)  # For Random Number of the News
